...
class _TimeConverterScreenState extends State<TimeConverterScreen> {
  ...
  final Map<String, double> _unitFactors = {
    ...
    'Days': 86400.0,
    'Weeks': 604800.0,
    'Months (30d)': 2592000.0,
    'Years (365d)': 31536000.0,
  };
  ...
  Widget _buildHeader(Color textColor) {
    return Column(
      ...
      children: [
        ...
        Text(
          'Convert duration across various time units accurately.',
          style: TextStyle(
            fontSize: 14,
      ...
      child: Column(
        children: [
          ...
          Align(
            ...
            child: Text(
              _result < 0.0001 ? _result.toStringAsExponential(4) : _result.toStringAsFixed(2),
              style: TextStyle(
                fontSize: 48,
                fontWeight: FontWeight.w300,
  ...
  Widget _buildQuickReferences(Color cardColor, Color textColor) {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            _buildRefCard('1 Hour', '3600 Sec', cardColor, textColor),
            const SizedBox(width: 16),
            _buildRefCard('1 Day', '24 Hours', cardColor, textColor),
          ],
        ),
      ],
    );
